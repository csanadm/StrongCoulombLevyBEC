...
//  int Nrt = 12000;
  ...
  stringstream outfile_name(""); outfile_name << "CorrFunc_protons_raw_table_" << ijob << ".dat";
  stringstream logfile_name(""); logfile_name << "log_CorrFunc_protons_raw_table_" << ijob << ".log";
