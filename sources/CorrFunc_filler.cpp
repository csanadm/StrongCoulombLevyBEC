...
#define K_CONST (139.57 / 2. / 137.036)
#define NJOBS 251
...
//  int Nrt = 12000;
  ...
  stringstream outfile_name(""); outfile_name << "CorrFunc_raw_table_" << ijob << ".dat";
  stringstream logfile_name(""); logfile_name << "log_CorrFunc_raw_table_" << ijob << ".log";
